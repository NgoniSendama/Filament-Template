...
@section('content')
  <!-- Blog Article -->
  <div class="max-w-screen-xl px-4 sm:px-6 lg:px-8 py-20 mx-auto">
        <div class="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 lg:gap-x-6 lg:gap-x-12">
            <!-- Content -->
            <div class="lg:col-span-2">
                <div class="py-8 lg:pr-8">
                    <div class="space-y-5 lg:space-y-8">
                        <a class="inline-flex items-center gap-x-1.5 text-sm text-gray-600 decoration-2 hover:underline dark:text-blue-400 mb-3"
                            href="{{ route('blog') }}">
                        ...
                        <h2 class="text-xl font-bold lg:text-3xl dark:text-white mb-3">{{ $blog->heading }}</h2>

                        <div class="flex items-center gap-x-3 mb-6">
                            <a class="inline-flex items-center gap-1.5 py-1 px-3 sm:py-2 sm:px-4 rounded-full text-xs sm:text-sm bg-gray-100 text-gray-800 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-800 dark:text-gray-200 mr-9"
                                href="#">
                                Company News
                            </a>
                            <p class="text-xs sm:text-sm text-gray-800 dark:text-gray-200">
                                {{ $blog->created_at->format('d F Y') }}</p>
                        </div>

                        <figure>
                            <img class="w-full object-cover rounded-xl mb-6" src="/storage/{{ $blog->image }}"
                                alt="{{ $blog->heading }}">
                        </figure>

                        <p class="text-lg text-gray-800 dark:text-gray-200 my-6">
                            {!! $blog->description !!}
                        </p>
            ...
            <!-- Sidebar -->
            <div
                class="lg:col-span-1 lg:w-full lg:h-full border px-2 dark:from-slate-800">
                <div class="sticky top-0 left-0 py-8 pl-4 lg:pl-8">
                    <!-- Avatar Media -->
                    <div class="group flex items-center gap-x-3 border-b border-gray-200 pb-8 mb-8 dark:border-gray-700">
                        ...
                        <div class="grow">
                            <div class="flex justify-end">
                                <button type="button"
                                    class="py-2 px-3 inline-flex justify-center items-center gap-x-1.5 rounded-full border border-transparent font-semibold bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 text-xs">
                    ...
                    <div class="space-y-6">
                        ...
                        @foreach ($blogs as $blog)
                            <a class="group flex items-center gap-x-6" href="{{ route('blog.show', $blog->slug) }}">
                                <div class="grow">
                                    <span
                                ...
                                <div class="flex-shrink-0 relative rounded-lg overflow-hidden w-20 h-20">
                                    <img class="w-full h-full absolute top-0 left-0 object-cover rounded-lg"
                                        src="/storage/{{ $blog->image }}" alt="{{ $blog->heading }}">
                                </div>
                            </a>
                        @endforeach
                        <!-- End Media -->
